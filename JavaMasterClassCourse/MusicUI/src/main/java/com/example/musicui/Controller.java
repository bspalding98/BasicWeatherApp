...
// Since both album and artist have name, hacked a bit of code through the project to be able to use just one table for multiple tables
...
//        final Artist artist = (Artist) artistTable.getSelectionModel().getSelectedItem();
        //Above is what we normally do, below is simulating AC/DC and it's in position 2
